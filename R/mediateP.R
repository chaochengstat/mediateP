...
mediate_contY_contM=function(data=mydata,
                             outcome="Y",
                             mediator="M",
                             exposure="X",
...
Mediate_contY_contM_bootci=function(data=mydata,
                                    outcome="Y",
                                    mediator="M",
                                    exposure="X",
                                    covariateY=c("X1","X2"),
...
#
####################################################################
mediate_contY_binaM=function(data=mydata,
                             outcome="Y",
                             mediator="M",
                             exposure="X",
                             covariateY=c("X1","X2","X3","X4","X5","X6","X7","X8"),
...
Mediate_contY_binaM_bootci=function(data=mydata,
                                    outcome="Y",
                                    mediator="M",
                                    exposure="X",
                                    covariateY=c("X1","X2"),
...
mediate_binaY_contM=function(data=mydata,
                             outcome="Y",
                             mediator="M",
                             exposure="X",
                             covariateY=c("X1","X2","X3","X4","X5","X6","X7","X8"),
  ...
  NIE_unbiased = function(theta,loc_gamma_0=loc_gamma_0,loc_gamma_c=loc_gamma_c,loc_beta_0=loc_beta_0,loc_beta_c=loc_beta_c,
    ...
    if (is.null(loc_gamma_c)) {
      p11s= gauss.hermite(f=f11,mu=gamma0+gamma1*x1,sd=sqrt(sigma2),order=20)
      p10s= gauss.hermite(f=f10,mu=gamma0+gamma1*x0s,sd=sqrt(sigma2),order=20)
    } else {
      p11s= gauss.hermite(f=f11,mu=gamma0+gamma1*x1+sum(gamma_c*cM),sd=sqrt(sigma2),order=20)
      p10s= gauss.hermite(f=f10,mu=gamma0+gamma1*x0s+sum(gamma_c*cM),sd=sqrt(sigma2),order=20)
    }
  ...
  TE_unbiased = function(theta,loc_gamma_0=loc_gamma_0,loc_gamma_c=loc_gamma_c,loc_beta_0=loc_beta_0,loc_beta_c=loc_beta_c,
    ...
    if (is.null(loc_gamma_c)) {
      ...
      p11s= gauss.hermite(f=f11,mu=gamma0+gamma1*x1+sum(gamma_c*cM),sd=sqrt(sigma2),order=20)
      p00s= gauss.hermite(f=f00,mu=gamma0+gamma1*x0s+sum(gamma_c*cM),sd=sqrt(sigma2),order=20)
    }
...
Mediate_binaY_contM_bootci=function(data=mydata,
                                    outcome="Y",
                                    mediator="M",
                                    exposure="X",
                                    covariateY=c("X1","X2"),
...
#
####################################################################
mediate_binaY_binaM=function(data=mydata,
                             outcome="Y",
                             mediator="M",
                             exposure="X",
                             covariateY=c("X1","X2","X3","X4","X5","X6","X7","X8"),
...
Mediate_binaY_binaM_bootci=function(data=mydata,
                                    outcome="Y",
                                    mediator="M",
                                    exposure="X",
                                    covariateY=c("X1","X2"),
